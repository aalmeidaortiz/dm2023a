...
PARAM  <- list()
PARAM$experimento  <- "EZZ7951_8_1" #EZZ7951_8_1,EZZ7951_8_2,
PARAM$exp_input  <- "EHT7511_8"

PARAM$modelos_rank  <- c( 5 ) #5,10 #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 75   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
