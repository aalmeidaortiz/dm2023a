...
PARAM  <- list()
PARAM$experimento  <- "EZZ7951_5_1" #EZZ7951_5_1,EZZ7951_5_2,EZZ7951_5_3
PARAM$exp_input  <- "EHT7511_5"

PARAM$modelos_rank  <- c( 3 )  #3,8,13 #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 60   #60,30(sólo para el rank 13) #cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 100069  # se utiliza para generar el vector de  PARAM$semillerio  semillas
