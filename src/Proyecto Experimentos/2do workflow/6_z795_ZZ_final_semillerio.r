...
PARAM  <- list()
PARAM$experimento  <- "EZZ7951_7" #EZZ7951_7,  EZZ7951_8,
PARAM$exp_input  <- "EHT7511_7"

PARAM$modelos_rank  <- c( 3 ) #3,12 #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 60 #60,30  # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
