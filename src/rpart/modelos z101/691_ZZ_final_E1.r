...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910_E1"
PARAM$exp_input  <- "HT6510_E1"
...
PARAM$semillas  <- c( 111119, 333331, 444113, 555119, 777769, 100019, 100069, 100103, 100109, 100129) #reemplazar por las propias semillas

PARAM$kaggle$envios_desde  <-  11500L
PARAM$kaggle$envios_hasta  <- 11500L
PARAM$kaggle$envios_salto  <-   0L
